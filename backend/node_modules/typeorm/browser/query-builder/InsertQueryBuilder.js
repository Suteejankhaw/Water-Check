            ...
            if (this.connection.driver.supportedUpsertTypes.includes("on-conflict-do-update")) {
                if (this.expressionMap.onIgnore) {
                    ...
                    if (Array.isArray(overwrite)) {
                        updatePart.push(...overwrite === null || overwrite === void 0 ? void 0 : overwrite.map((column) => `${this.escape(column)} = EXCLUDED.${this.escape(column)}`));
                    }
                    else if (columns) {
                    ...
                    if (updatePart.length > 0) {
                        ...
                        updatePart.push(...this.expressionMap
                            ...
                            !(overwrite === null || overwrite === void 0 ? void 0 : overwrite.includes(column.databaseName)) &&
